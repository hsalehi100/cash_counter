...
function money(form) {
  hun = s(document.getElementById("hundred").value, 100); // Each amount is the returned value
  fif = s(document.getElementById("fifty").value, 50);  // for the amount in the s() function
  twe = s(document.getElementById("twenty").value, 20);
  ten = s(document.getElementById("ten").value, 10);
  fiv = s(document.getElementById("five").value, 5);
  two = s(document.getElementById("toonie").value, 2);
  one = s(document.getElementById("loonie").value, 1);
  qtr = s(document.getElementById("twentyfive_cent").value, .25);
  dme = s(document.getElementById("ten_cent").value, .1);
  nck = s(document.getElementById("five_cent").value, .05);
  ...
  document.getElementById("total").innerHTML = ttl; // display total amount
